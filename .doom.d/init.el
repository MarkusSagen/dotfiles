...
(doom! :input
       ...
       (org                ; organize your plain life in plain text
        ...
        +capture           ; org-capture inside and outside of doom emacs
        +deft
        +dragndrop         ; drag and drop
        +drill
        +noter             ;
        +hugo              ; for making blogs
        +jupyter           ; ipython/jupyter support
        +pandoc            ;
        +present           ; org-mode for presentations
        +ref               ;
        +roam              ; For bidiretional linking and slipbox method
        )
